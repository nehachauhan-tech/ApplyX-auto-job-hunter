...
export default function LoginPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-dark-700 mb-2">Welcome back</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              type="checkbox"
              className="w-4 h-4 rounded border-primary-200 text-primary-500 focus:ring-primary-500"
            />
      ...
      <div className="mt-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-cream-100 text-dark-200">Or continue with</span>
          </div>
        </div>

        <div className="mt-6 grid grid-cols-2 gap-4">
          <button className="flex items-center justify-center gap-2 px-4 py-3 border border-primary-200 rounded-xl hover:bg-white transition-colors">
          ...
          <button className="flex items-center justify-center gap-2 px-4 py-3 border border-primary-200 rounded-xl hover:bg-white transition-colors">
            ...
            <span className="text-sm font-medium text-dark-700">LinkedIn</span>
          </button>
        </div>
      </div>
