...
export default function Platforms() {
  ...
  return (
    <section
      id="platforms"
      className="section-padding bg-gradient-to-b from-cream-100 to-beige-100"
      ref={ref}
    >
      <div className="container-max mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-charcoal-900 mb-4">
            One Platform,{" "}
            <span className="text-accent-teal">Endless Opportunities</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-12">
          {platforms.map((platform, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-white rounded-xl p-5 border border-beige-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 h-full">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <ExternalLink className="w-4 h-4 text-charcoal-400 opacity-0 group-hover:opacity-100 transition-opacity" />
                </div>
        ...
        <motion.div
          ...
          className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-beige-200"
        >
              ...
              <div className="bg-cream-100 rounded-xl p-6">
                <div className="space-y-3">
                  {["LinkedIn", "Indeed", "Naukri"].map((name, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between bg-white rounded-lg p-4 border border-beige-200"
                    >
                  ...
                  <div className="flex items-center justify-between bg-white/50 rounded-lg p-4 border border-dashed border-beige-300">
                    <div className="flex items-center gap-3">
